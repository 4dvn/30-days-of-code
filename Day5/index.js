...
function getArticlesByAuth(intent, session, callback) {
    ...
    let query = `posts/?client_id=ghost-frontend&client_secret=123257bef36d&include=authors&filter=authors:[${author}]`;
